...
export function getSdk(
  ...
  return {
    GetCerts(
      variables: GetCertsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetCertsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetCertsQuery>(GetCertsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "GetCerts",
    ...
    GetEds(
      variables: GetEdsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetEdsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetEdsQuery>(GetEdsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "GetEds",
    ...
    GetInterests(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetInterestsQuery>(GetInterestsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "GetInterests",
    ...
    GetLangs(
      variables: GetLangsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetLangsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetLangsQuery>(GetLangsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "GetLangs",
    ...
    GetVolunteers(
      variables: GetVolunteersQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetVolunteersQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetVolunteersQuery>(GetVolunteersDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "GetVolunteers",
    ...
    GetXps(
      variables: GetXpsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetXpsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetXpsQuery>(GetXpsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "GetXps",
