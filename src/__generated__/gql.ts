...
export const GetCertsDocument = gql`
  ...
  certs(locale: $locale, sort: "received:desc") {
    ...
    `;
export const GetEdsDocument = gql`
...
export const GetXpsDocument = gql`
  ...
  xps(locale: $locale, sort: "start:desc") {
    data {
      id
      attributes {
        locale
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetCerts(variables: GetCertsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetCertsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetCertsQuery>(GetCertsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetCerts', 'query', variables);
    },
    ...
    GetSkills(variables: GetSkillsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetSkillsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetSkillsQuery>(GetSkillsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetSkills', 'query', variables);
    },
    GetVolunteers(variables: GetVolunteersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetVolunteersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetVolunteersQuery>(GetVolunteersDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetVolunteers', 'query', variables);
    },
    GetXps(variables: GetXpsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetXpsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetXpsQuery>(GetXpsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetXps', 'query', variables);
    }
  };
}
